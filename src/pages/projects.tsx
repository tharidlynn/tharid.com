          ...
          <div className="flex items-center border border-gray-200 dark:border-gray-800 rounded p-4">
            ...
            <div>
              ...
              <p className="leading-5 text-gray-700 dark:text-gray-300">
                Build and deploy a modern Jamstack application using the most popular open-source
                software.
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center border border-gray-200 dark:border-gray-800 rounded p-4">
            ...
            <div>
              ...
              <p className="leading-5 text-gray-700 dark:text-gray-300">
                A free video course for building static and server-side rendered applications with
                Next.js and React.
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center border border-gray-200 dark:border-gray-800 rounded p-4">
            ...
            <div>
              ...
              <p className="leading-5 text-gray-700 dark:text-gray-300">
                The easiest way to add comments or reviews to your static site. Built as part of
                React 2025.
              </p>
            </div>
          </div>
